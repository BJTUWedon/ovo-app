...
def wearglass(request):
    ...
    # img1=Image.open('1995419774.jpg')
    img64 = str(img64[23:])
    ...
    img1.save("./rotate.jpg")
    f = open('rotate.jpg','rb')
    img = base64.b64encode(f.read())
    params={'image':''+str(img)+'','image_type':'BASE64','face_field':'age,faceshape,gender,landmark'}
    ...
    print glass.size[0]
    x_s = int(glass.size[0]*ratio*1.15)
    y_s = y*x_s/x
    ...
    img1.paste(out,(placex,placey+int(0.02*glass.size[0])),mask=out)
